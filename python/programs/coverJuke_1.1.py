...
class window0(wx.Frame):
    def __init__(self,*args,**kwargs):
        ...
        self.albumBox = wx.StaticBox(self,label='Select Album (%d)' % dj.nAlbums)
        self.albumBoxSizer = wx.StaticBoxSizer(self.albumBox)
        ...
        self.albumBoxSizer.Add(self.coverPanel,flag=wx.EXPAND)

        self.sizer.Add(self.albumBoxSizer,flag=wx.EXPAND)
