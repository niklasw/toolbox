...
limbalk1 = rectangularSection(limtra,b=90*mm,h=270*mm)
limbalk2 = rectangularSection(limtra,b=56*mm,h=270*mm)
...
altanTakBeam=beam(single190,3.7)
delta = altanTakBeam.uniformLoadDeflection(2000*0.72)
print 'Altantak takbalk deflecton = ', delta
