...
{
		double dqdt[10000];	//array hold time derivate of q;
		double k1[10000];
		double k2[10000];
		double k3[10000];
		double k4[10000];	
		...
		for (int i=0;i<N;i++)	//loop over all faces but the last due to symmetry
		{
			...
			dqdt[c1]=dqdt[c1]-1/cell_size*(flux_function_1(i,alfa,q));
			dqdt[c2]=dqdt[c2]+1/cell_size*(flux_function_1(i,alfa,q));	
		}
		for (int i=1;i<=N;i++)
		{
			q[i]=q[i]+dt*dqdt[i];
		...
		for (int i=0;i<N;i++)	//loop over all faces but the last due to symmetry
		{
			...
			int c2=f[i][1];
			double cell_size=1.0/N;
			dqdt[c1]=dqdt[c1]-1/cell_size*(flux_function_1(i,alfa,q2));
			dqdt[c2]=dqdt[c2]+1/cell_size*(flux_function_1(i,alfa,q2));	
		}
		for (int i=1;i<=N;i++)
		{
			k2[i]=dt*dqdt[i];
		...
		for (int i=0;i<N;i++)	//loop over all faces but the last due to symmetry
		{
			...
			int c2=f[i][1];
			double cell_size=1.0/N;
			dqdt[c1]=dqdt[c1]-1/cell_size*(flux_function_1(i,alfa,q3));
			dqdt[c2]=dqdt[c2]+1/cell_size*(flux_function_1(i,alfa,q3));	
		}
		for (int i=1;i<=N;i++)
		{
			k3[i]=dt*dqdt[i];
		...
		for (int i=0;i<N;i++)	//loop over all faces but the last due to symmetry
		{
			...
			int c2=f[i][1];
			double cell_size=1.0/N;
			dqdt[c1]=dqdt[c1]-1/cell_size*(flux_function_1(i,alfa,q4));
			dqdt[c2]=dqdt[c2]+1/cell_size*(flux_function_1(i,alfa,q4));	
		}
		for (int i=1;i<=N;i++)
		{
			k4[i]=dt*dqdt[i];
